...
class CatalogSpec extends BaseSpec with TableDrivenPropertyChecks {
  ...
  "findBookByIsbn" should {
    val findByIsbnCases = Table(
      ...
      (
        "theEpicOfGilgamesh",
        theEpicOfGilgamesh.isbn,
        Some[List[BookCard]](List(theEpicOfGilgamesh))
      ),
  ...
  "findBookByAuthor" should {
    ...
    forAll(findByAuthorCases) {
      (statement: String, author: String, result: Option[List[BookCard]]) =>
  ...
  "findBookByTopic" should {
    val findByTopicCases = Table(
      ...
      (
        "theEpicOfGilgamesh",
        (Set[Topic](Gilgamesh, Persia, Royalty)),
        Some[List[BookCard]](List(theEpicOfGilgamesh))
      ),
      ("phaedrus", Set[Topic](Philosophy), Some[List[BookCard]](List(phaedrus))),
      (
        "phaedrus and theHistories",
        Set[Topic](Greece, Philosophy),
        Some[List[BookCard]](List(phaedrus, theHistories))
      ),
      (
        "theHistories",
        Set[Topic](Africa, Asia, Greece, Tradition),
        Some[List[BookCard]](List(phaedrus, theHistories))
      ),
    ...
    forAll(findByTopicCases) {
      (statement: String, topics: Set[Topic], result: Option[List[BookCard]]) =>
